...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                {
                    ""name"": ""ScreenPosition"",
                    ""type"": ""Value"",
                    ""id"": ""073aab11-9f10-4329-8faf-8b64dfe798b2"",
                ...
                },
                {
                    ""name"": ""Select"",
                    ""type"": ""Button"",
                    ""id"": ""5720dac3-ab39-48e3-bb53-41cd7a06b54b"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""ec989914-af89-4235-ac7b-9edb4a83dc7f"",
                    ""path"": ""<Mouse>/position"",
                    ""interactions"": """",
                    ""processors"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""0a5957b9-d2c5-43dc-bdf8-f711fb77a90a"",
                ...
                {
                    ""name"": """",
                    ""id"": ""7b98f591-9822-4e0b-ad51-eb633f98f761"",
                ...
                {
                    ""name"": """",
                    ""id"": ""645383f6-886c-45fd-ad68-3e37e92a913f"",
        ...
        {
            ""name"": ""RepairStation"",
            ""id"": ""727672dd-d360-456d-9576-c56925a6e437"",
            ""actions"": [
                {
                    ""name"": ""New action"",
                    ""type"": ""Button"",
                    ""id"": ""36972f5f-14f7-4c49-924d-3b145ed69e36"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""1e9f74c4-2461-485d-83c8-42f87b352121"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    // RepairStation
    private readonly InputActionMap m_RepairStation;
    private List<IRepairStationActions> m_RepairStationActionsCallbackInterfaces = new List<IRepairStationActions>();
    private readonly InputAction m_RepairStation_Newaction;
    public struct RepairStationActions
    {
        private @InputSystem_Actions m_Wrapper;
        public RepairStationActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        public InputAction @Newaction => m_Wrapper.m_RepairStation_Newaction;
        public InputActionMap Get() { return m_Wrapper.m_RepairStation; }
        public void Enable() { Get().Enable(); }
        public void Disable() { Get().Disable(); }
        public bool enabled => Get().enabled;
        public static implicit operator InputActionMap(RepairStationActions set) { return set.Get(); }
        public void AddCallbacks(IRepairStationActions instance)
        {
            if (instance == null || m_Wrapper.m_RepairStationActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_RepairStationActionsCallbackInterfaces.Add(instance);
            @Newaction.started += instance.OnNewaction;
            @Newaction.performed += instance.OnNewaction;
            @Newaction.canceled += instance.OnNewaction;
        }

        private void UnregisterCallbacks(IRepairStationActions instance)
        {
            @Newaction.started -= instance.OnNewaction;
            @Newaction.performed -= instance.OnNewaction;
            @Newaction.canceled -= instance.OnNewaction;
        ...
        public void RemoveCallbacks(IRepairStationActions instance)
        {
            if (m_Wrapper.m_RepairStationActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IRepairStationActions instance)
        {
            foreach (var item in m_Wrapper.m_RepairStationActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_RepairStationActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
